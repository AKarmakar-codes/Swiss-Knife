"""
Analyse overlap across the three PKU DPO v2 objective JSONL files.
(v2 = disjoint partition produced by preprocess_pku_v2.py)
...
Expected on v2: chosen/rejected/triple overlaps should be ~0 by construction.
Prompt overlap can still be >0 (same user prompt can appear in different
safety-pair slices).

Usage:
  python analyse_overlap_v2.py
"""
